...
CREATE TABLE `komponenten` (
  ...
  `k_geloescht` tinyint(1) NOT NULL,
  PRIMARY KEY (`k_id`),
  KEY `fk_komponenten_haendler` (`l_id`),
  KEY `fk_komponenten_komponentenarten1` (`ka_id`),
  CONSTRAINT `fk_komponenten_haendler` FOREIGN KEY (`l_id`) REFERENCES `lieferant` (`l_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `lieferant` (
  ...
  `l_geloescht` tinyint(1) NOT NULL,
  PRIMARY KEY (`l_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `raeume` (
  ...
  `r_geloescht` tinyint(1) NOT NULL,
  PRIMARY KEY (`r_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-27 15:06:40
